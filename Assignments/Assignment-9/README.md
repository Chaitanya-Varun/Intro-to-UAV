In this assignment we use a gyrosensor to integrate the gyro data for path correction and drive the bot in a square and identify the path traced by it.
